...
/* Parameter 1 ---------------------------------------------------------------*/
#define PARAMETER_1_MAX_VELOCITY 0.3     // [m/s]
#define PARAMETER_1_MAX_ACCELERATION 1.5 // [m/ss]
#define PARAMETER_1_VELOCITY_PID_KP 10.0
#define PARAMETER_1_VELOCITY_PID_KI 0.0
#define PARAMETER_1_VELOCITY_PID_KD 0.0
#define PARAMETER_1_MAX_ANGULAR_VELOCITY 10.0     // [rad/s]
#define PARAMETER_1_MAX_ANGULAR_ACCELERATION 20.0 // [rad/ss]
#define PARAMETER_1_ANGULAR_VELOCITY_PID_KP 0.6
