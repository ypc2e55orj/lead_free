...
#define SET_PARAMETER(num)                                                                      \
  ...
  {                                                                                             \
    ...
    parameters[num].lineAngularVelocityPid[0] = PARAMETER_##num##_LINE_ANGULAR_VELOCITY_PID_KP; \
    parameters[num].lineAngularVelocityPid[1] = PARAMETER_##num##_LINE_ANGULAR_VELOCITY_PID_KI; \
    parameters[num].lineAngularVelocityPid[2] = PARAMETER_##num##_LINE_ANGULAR_VELOCITY_PID_KD; \
  } while (0)
